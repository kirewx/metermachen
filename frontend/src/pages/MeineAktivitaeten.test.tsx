...
vi.mock('../api/client', () => ({
  api: {
    ...
    achievements: vi.fn().mockResolvedValue([
      ...
      { key: 'early_bird', title: 'Early Bird', description: 'Schon am ersten Tag der Saison eine Aktivität eingetragen.', icon: 'fahne',
        achieved: false, progress: 0, parts: [], hidden: false, tier: null, discipline: null,
        unlocked_at: null, emoji: '🐦', showcased: null, claimed_by: null },
      { key: 'zeit_an_der_spitze', title: 'Zeit an der Spitze', description: 'Deine Gesamtzeit als alleiniger Platz 1 der Saison.', icon: 'pokal',
